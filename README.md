...
This project provides sample and convenient wrapper code to utilize this API. 

*Note you need a Bria desktop (Version 4.8 or higher, 5.X recommended) application to utilize the API.*
